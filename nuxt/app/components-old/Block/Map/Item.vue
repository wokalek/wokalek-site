<template>
  <NuxtLink
    ...
    class="item
      ...
      border-1-1 border-grey-6 dark:border-grey-2
    "
  ...
  <div
    ...
    class="item
      ...
      border-1-1 border-grey-3 dark:border-grey-4
      text-grey-3 dark:text-grey-4
    "
    :class="{ disabled: isDisabled }"
    :disabled="isDisabled"
  >
...
.item
  &::after
    ...
    @apply border-1-1 border-grey-6 dark:border-grey-2
