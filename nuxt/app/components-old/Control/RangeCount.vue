<template>
  <div
    ref="slider"
    class="lead flex justify-center border-1-1 border-grey-3 dark:border-grey-4"
    role="slider"
    :aria-label="label"
    :aria-valuenow="value"
  ...
  >
    <button
      ...
      :class="{ 'text-grey-4 cursor-default': value === minValue }"
    ...
    <button
      class="flex justify-center items-center leading-1 select-none size-64-32 text-38-24 font-light"
      :class="{ 'text-grey-4 cursor-default': value === maxValue }"
