...
![Переключаем туда-сюда и&nbsp;смотрим, что масштаб текста и&nbsp;отступов сохраняется — gif](/static/articles/adaptive-design/adaptive-fluid-test.gif){width="1337" height="795"}
...
![Готовый результат главной страницы моего сайта, который резинется абсолютно на&nbsp;всех разрешениях — gif](/static/articles/adaptive-design/end-result.gif){width="1367" height="838"}
