    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', imagefield.fields.ImageField(height_field='image_height', upload_to='photos', verbose_name='Изображение', width_field='image_width')),
                ...
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='photos.section', verbose_name='Раздел')),
            ],
            options={
                'verbose_name': 'фото',
