...
class Query:
    ...
    @strawberry_django.field
    def articles(
        self, order: ArticleOrder | None = strawberry.UNSET
    ) -> list[ArticleType]:
    ...
    @strawberry_django.field
    def photos(self, order: PhotoOrder | None = strawberry.UNSET) -> list[PhotoType]:
    ...
    @strawberry_django.field
    def drawings(
        self, order: DrawingOrder | None = strawberry.UNSET
    ) -> list[DrawingType]:
